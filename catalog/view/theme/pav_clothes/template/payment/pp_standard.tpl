...
<form action="<?php echo $action; ?>" method="post">
  ...
  <div class="buttons" style="display:none">
    <div class="pull-right">
      <input type="submit" value="<?php echo $button_confirm; ?>" class="btn btn-primary" id="paypal_button" />
    </div>
  </div>
...
<div class="center"><img src="/catalog/view/theme/pav_clothes/image/lodding.gif"  /></div>
