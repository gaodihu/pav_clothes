...
class ControllerCheckoutNicoCheckout extends Controller { 
	...
	public function login_validate($data = array()) {
		$opencart2 = $data['opencart2'] = ((int)substr(VERSION,0,1) == 2);
		if ($data['opencart2']) $this->load->language('checkout/nicocheckout'); else $this->language->load('checkout/checkout');
...
//				error_log(print_r($this->session->data['payment_methods'],1));
	...
	public function shipping_method($render = true, &$data = array()) 
	{
		...
		$shipping_address = array('country_id' => 0, 'zone_id' => 0, 'city' => '', 'postcode' => '','firstname' => '', 'lastname' => '', 'company' => '', 'address_1' => '');
/*
