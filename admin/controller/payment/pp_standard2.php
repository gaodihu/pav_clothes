...
class ControllerPaymentPPStandard2 extends Controller {
	...
	public function index() {
		$this->load->language('payment/pp_standard2');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			unset($this->request->post['pp_standard2_module']);

			$this->model_setting_setting->editSetting('pp_standard2', $this->request->post);
		...
		$data['text_ipn_url'] = HTTPS_CATALOG . 'index.php?route=payment/pp_standard2/ipn';
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/pp_standard2', 'token=' . $this->session->data['token'], 'SSL'),
		);

		$data['action'] = $this->url->link('payment/pp_standard2', 'token=' . $this->session->data['token'], 'SSL');
		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], 'SSL');
		$data['search'] = $this->url->link('payment/pp_standard2/search', 'token=' . $this->session->data['token'], 'SSL');

		if (isset($this->request->post['pp_standard2_username'])) {
			$data['pp_standard2_username'] = $this->request->post['pp_standard2_username'];
		} else {
			$data['pp_standard2_username'] = $this->config->get('pp_standard2_username');
		}

		if (isset($this->request->post['pp_standard2_password'])) {
			$data['pp_standard2_password'] = $this->request->post['pp_standard2_password'];
		} else {
			$data['pp_standard2_password'] = $this->config->get('pp_standard2_password');
		}

		if (isset($this->request->post['pp_standard2_signature'])) {
			$data['pp_standard2_signature'] = $this->request->post['pp_standard2_signature'];
		} else {
			$data['pp_standard2_signature'] = $this->config->get('pp_standard2_signature');
		}

		if (isset($this->request->post['pp_standard2_sandbox_username'])) {
			$data['pp_standard2_sandbox_username'] = $this->request->post['pp_standard2_sandbox_username'];
		} else {
			$data['pp_standard2_sandbox_username'] = $this->config->get('pp_standard2_sandbox_username');
		}

		if (isset($this->request->post['pp_standard2_sandbox_password'])) {
			$data['pp_standard2_sandbox_password'] = $this->request->post['pp_standard2_sandbox_password'];
		} else {
			$data['pp_standard2_sandbox_password'] = $this->config->get('pp_standard2_sandbox_password');
		}

		if (isset($this->request->post['pp_standard2_sandbox_signature'])) {
			$data['pp_standard2_sandbox_signature'] = $this->request->post['pp_standard2_sandbox_signature'];
		} else {
			$data['pp_standard2_sandbox_signature'] = $this->config->get('pp_standard2_sandbox_signature');
		}

		if (isset($this->request->post['pp_standard2_test'])) {
			$data['pp_standard2_test'] = $this->request->post['pp_standard2_test'];
		} else {
			$data['pp_standard2_test'] = $this->config->get('pp_standard2_test');
		}

		if (isset($this->request->post['pp_standard2_method'])) {
			$data['pp_standard2_method'] = $this->request->post['pp_standard2_method'];
		} else {
			$data['pp_standard2_method'] = $this->config->get('pp_standard2_method');
		}

		if (isset($this->request->post['pp_standard2_total'])) {
			$data['pp_standard2_total'] = $this->request->post['pp_standard2_total'];
		} else {
			$data['pp_standard2_total'] = $this->config->get('pp_standard2_total');
		}

		if (isset($this->request->post['pp_standard2_debug'])) {
			$data['pp_standard2_debug'] = $this->request->post['pp_standard2_debug'];
		} else {
			$data['pp_standard2_debug'] = $this->config->get('pp_standard2_debug');
		}

		if (isset($this->request->post['pp_standard2_currency'])) {
			$data['pp_standard2_currency'] = $this->request->post['pp_standard2_currency'];
		} else {
			$data['pp_standard2_currency'] = $this->config->get('pp_standard2_currency');
		}

		$data['currency_codes'] = $this->model_payment_pp_standard2->currencyCodes();

		$this->load->model('localisation/order_status');

		$data['order_statuses'] = $this->model_localisation_order_status->getOrderStatuses();

		if (isset($this->request->post['pp_standard2_canceled_reversal_status_id'])) {
			$data['pp_standard2_canceled_reversal_status_id'] = $this->request->post['pp_standard2_canceled_reversal_status_id'];
		} else {
			$data['pp_standard2_canceled_reversal_status_id'] = $this->config->get('pp_standard2_canceled_reversal_status_id');
		}

		if (isset($this->request->post['pp_standard2_completed_status_id'])) {
			$data['pp_standard2_completed_status_id'] = $this->request->post['pp_standard2_completed_status_id'];
		} else {
			$data['pp_standard2_completed_status_id'] = $this->config->get('pp_standard2_completed_status_id');
		}

		if (isset($this->request->post['pp_standard2_denied_status_id'])) {
			$data['pp_standard2_denied_status_id'] = $this->request->post['pp_standard2_denied_status_id'];
		} else {
			$data['pp_standard2_denied_status_id'] = $this->config->get('pp_standard2_denied_status_id');
		}

		if (isset($this->request->post['pp_standard2_expired_status_id'])) {
			$data['pp_standard2_expired_status_id'] = $this->request->post['pp_standard2_expired_status_id'];
		} else {
			$data['pp_standard2_expired_status_id'] = $this->config->get('pp_standard2_expired_status_id');
		}

		if (isset($this->request->post['pp_standard2_failed_status_id'])) {
			$data['pp_standard2_failed_status_id'] = $this->request->post['pp_standard2_failed_status_id'];
		} else {
			$data['pp_standard2_failed_status_id'] = $this->config->get('pp_standard2_failed_status_id');
		}

		if (isset($this->request->post['pp_standard2_pending_status_id'])) {
			$data['pp_standard2_pending_status_id'] = $this->request->post['pp_standard2_pending_status_id'];
		} else {
			$data['pp_standard2_pending_status_id'] = $this->config->get('pp_standard2_pending_status_id');
		}

		if (isset($this->request->post['pp_standard2_processed_status_id'])) {
			$data['pp_standard2_processed_status_id'] = $this->request->post['pp_standard2_processed_status_id'];
		} else {
			$data['pp_standard2_processed_status_id'] = $this->config->get('pp_standard2_processed_status_id');
		}

		if (isset($this->request->post['pp_standard2_refunded_status_id'])) {
			$data['pp_standard2_refunded_status_id'] = $this->request->post['pp_standard2_refunded_status_id'];
		} else {
			$data['pp_standard2_refunded_status_id'] = $this->config->get('pp_standard2_refunded_status_id');
		}

		if (isset($this->request->post['pp_standard2_reversed_status_id'])) {
			$data['pp_standard2_reversed_status_id'] = $this->request->post['pp_standard2_reversed_status_id'];
		} else {
			$data['pp_standard2_reversed_status_id'] = $this->config->get('pp_standard2_reversed_status_id');
		}

		if (isset($this->request->post['pp_standard2_voided_status_id'])) {
			$data['pp_standard2_voided_status_id'] = $this->request->post['pp_standard2_voided_status_id'];
		} else {
			$data['pp_standard2_voided_status_id'] = $this->config->get('pp_standard2_voided_status_id');
		}

		if (isset($this->request->post['pp_standard2_allow_note'])) {
			$data['pp_standard2_allow_note'] = $this->request->post['pp_standard2_allow_note'];
		} else {
			$data['pp_standard2_allow_note'] = $this->config->get('pp_standard2_allow_note');
		}

		if (isset($this->request->post['pp_standard2_logo'])) {
			$data['pp_standard2_logo'] = $this->request->post['pp_standard2_logo'];
		} else {
			$data['pp_standard2_logo'] = $this->config->get('pp_standard2_logo');
		}

		if (isset($this->request->post['pp_standard2_page_colour'])) {
			$data['pp_standard2_page_colour'] = str_replace('#', '', $this->request->post['pp_standard2_page_colour']);
		} else {
			$data['pp_standard2_page_colour'] = $this->config->get('pp_standard2_page_colour');
		}

		if (isset($this->request->post['pp_standard2_recurring_cancel_status'])) {
			$data['pp_standard2_recurring_cancel_status'] = $this->request->post['pp_standard2_recurring_cancel_status'];
		} else {
			$data['pp_standard2_recurring_cancel_status'] = $this->config->get('pp_standard2_recurring_cancel_status');
		}

		$this->load->model('tool/image');

		if (isset($this->request->post['pp_standard2_logo']) && is_file(DIR_IMAGE . $this->request->post['pp_standard2_logo'])) {
			$data['thumb'] = $this->model_tool_image->resize($this->request->post['pp_standard2_logo'], 750, 90);
		} elseif (is_file(DIR_IMAGE . $this->config->get('pp_standard2_logo'))) {
			$data['thumb'] = $this->model_tool_image->resize($this->config->get('pp_standard2_logo'), 750, 90);
		} else {
		...
		if (isset($this->request->post['pp_standard2_geo_zone_id'])) {
			$data['pp_standard2_geo_zone_id'] = $this->request->post['pp_standard2_geo_zone_id'];
		} else {
			$data['pp_standard2_geo_zone_id'] = $this->config->get('pp_standard2_geo_zone_id');
		}
		...
		if (isset($this->request->post['pp_standard2_status'])) {
			$data['pp_standard2_status'] = $this->request->post['pp_standard2_status'];
		} else {
			$data['pp_standard2_status'] = $this->config->get('pp_standard2_status');
		}

		if (isset($this->request->post['pp_standard2_sort_order'])) {
			$data['pp_standard2_sort_order'] = $this->request->post['pp_standard2_sort_order'];
		} else {
			$data['pp_standard2_sort_order'] = $this->config->get('pp_standard2_sort_order');
		}
		...
		$data['text_paypal_link'] = 'https://www.paypal.com/webapps/merchantboarding/webflow/externalpartnerflow?'
				...
				. '&returnToPartnerUrl=' . base64_encode(html_entity_decode($this->url->link('payment/pp_standard2/live', 'token=' . $this->session->data['token'], 'SSL')))
		...
		$data['text_paypal_link_sandbox'] = 'https://www.sandbox.paypal.com/webapps/merchantboarding/webflow/externalpartnerflow?'
				...
				. '&productIntentID=addipmt'
				. '&receiveCredentials=TRUE'
				. '&returnToPartnerUrl=' . base64_encode(html_entity_decode($this->url->link('payment/pp_standard2/sandbox', 'token=' . $this->session->data['token'], 'SSL')))
				. '&subIntegrationType=S';
		...
		$this->response->setOutput($this->load->view('payment/pp_standard2.tpl', $data));
	}
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'payment/pp_standard2')) {
			$this->error['warning'] = $this->language->get('error_permission');
		}

		if ($this->request->post['pp_standard2_test'] == 1) {
			if (!$this->request->post['pp_standard2_sandbox_username']) {
				$this->error['sandbox_username'] = $this->language->get('error_sandbox_username');
			}

			if (!$this->request->post['pp_standard2_sandbox_password']) {
				$this->error['sandbox_password'] = $this->language->get('error_sandbox_password');
			}

			if (!$this->request->post['pp_standard2_sandbox_signature']) {
				$this->error['sandbox_signature'] = $this->language->get('error_sandbox_signature');
			}
		} else {
			if (!$this->request->post['pp_standard2_username']) {
				$this->error['username'] = $this->language->get('error_username');
			}

			if (!$this->request->post['pp_standard2_password']) {
				$this->error['password'] = $this->language->get('error_password');
			}

			if (!$this->request->post['pp_standard2_signature']) {
	...
	public function live() {
		if (isset($this->request->get['merchantId'])) {
			...
			$token = $this->model_payment_pp_standard2->getTokens('live');

			if (isset($token->access_token)) {
				$user_info = $this->model_payment_pp_standard2->getUserInfo($this->request->get['merchantId'], 'live', $token->access_token);
			} else {
				$this->session->data['error_api'] = $this->language->get('error_api');
			}

			if (isset($user_info->api_user_name)) {
				$this->model_setting_setting->editSettingValue('pp_standard2', 'pp_standard2_username', $user_info->api_user_name);
				$this->model_setting_setting->editSettingValue('pp_standard2', 'pp_standard2_password', $user_info->api_password);
				$this->model_setting_setting->editSettingValue('pp_standard2', 'pp_standard2_signature', $user_info->signature);
			} else {
				$this->session->data['error_api'] = $this->language->get('error_api');
			}
		}
		$this->response->redirect($this->url->link('payment/pp_standard2', 'token=' . $this->session->data['token'], 'SSL'));
	}
	...
	public function sandbox() {
		if (isset($this->request->get['merchantId'])) {
			...
			$token = $this->model_payment_pp_standard2->getTokens('sandbox');

			if (isset($token->access_token)) {
				$user_info = $this->model_payment_pp_standard2->getUserInfo($this->request->get['merchantId'], 'sandbox', $token->access_token);
			} else {
				$this->session->data['error_api'] = $this->language->get('error_api_sandbox');
			}

			if (isset($user_info->api_user_name)) {
				$this->model_setting_setting->editSettingValue('pp_standard2', 'pp_standard2_sandbox_username', $user_info->api_user_name);
				$this->model_setting_setting->editSettingValue('pp_standard2', 'pp_standard2_sandbox_password', $user_info->api_password);
				$this->model_setting_setting->editSettingValue('pp_standard2', 'pp_standard2_sandbox_signature', $user_info->signature);
			} else {
				$this->session->data['error_api'] = $this->language->get('error_api_sandbox');
			}
		}
	...
	public function resend() {
		...
		if (isset($this->request->get['paypal_order_transaction_id'])) {
			$transaction = $this->model_payment_pp_standard2->getFailedTransaction($this->request->get['paypal_order_transaction_id']);

			if ($transaction) {
				$call_data = unserialize($transaction['call_data']);

				$result = $this->model_payment_pp_standard2->call($call_data);

				if ($result) {

					$parent_transaction = $this->model_payment_pp_standard2->getLocalTransaction($transaction['parent_transaction_id']);
					...
					$this->model_payment_pp_standard2->updateTransaction($transaction);
	...
	public function capture() {
		...
		if (isset($this->request->post['order_id']) && $this->request->post['amount'] > 0 && isset($this->request->post['order_id']) && isset($this->request->post['complete'])) {
			...
			$paypal_order = $this->model_payment_pp_standard2->getOrder($this->request->post['order_id']);
			...
			if ($result == false) {
				...
				$paypal_order_transaction_id = $this->model_payment_pp_standard2->addTransaction($transaction, $call_data);
				...
				$captured = number_format($this->model_payment_pp_standard2->totalCaptured($paypal_order['paypal_order_id']), 2);
				$refunded = number_format($this->model_payment_pp_standard2->totalRefundedOrder($paypal_order['paypal_order_id']), 2);
				...
				if ($transaction['remaining'] == 0.00) {
					...
					$this->model_payment_pp_standard2->updateOrder('Complete', $this->request->post['order_id']);
				}
				...
				if ($this->request->post['complete'] == 1 && $transaction['remaining'] > 0) {
					...
					$this->model_payment_pp_standard2->addTransaction($transaction['void']);
					$this->model_payment_pp_standard2->updateOrder('Complete', $this->request->post['order_id']);
	...
	public function refund() {
		...
		$this->load->language('payment/pp_standard2_refund');
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('text_pp_standard2'),
			'href' => $this->url->link('payment/pp_standard2', 'token=' . $this->session->data['token'], 'SSL'),
		);

		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('payment/pp_standard2/refund', 'token=' . $this->session->data['token'], 'SSL'),
		);

		//button actions
		$data['action'] = $this->url->link('payment/pp_standard2/doRefund', 'token=' . $this->session->data['token'], 'SSL');
		$data['cancel'] = $this->url->link('payment/pp_standard2', 'token=' . $this->session->data['token'], 'SSL');

		$data['transaction_id'] = $this->request->get['transaction_id'];

		$this->load->model('payment/pp_standard2');
		$pp_transaction = $this->model_payment_pp_standard2->getTransaction($this->request->get['transaction_id']);

		$data['amount_original'] = $pp_transaction['AMT'];
		$data['currency_code'] = $pp_transaction['CURRENCYCODE'];

		$refunded = number_format($this->model_payment_pp_standard2->totalRefundedTransaction($this->request->get['transaction_id']), 2);
		...
		$this->response->setOutput($this->load->view('payment/pp_standard2_refund.tpl', $data));
	}
	...
	public function doRefund() {
		...
		if (isset($this->request->post['transaction_id']) && isset($this->request->post['refund_full'])) {
			...
			if ($this->request->post['refund_full'] == 0 && $this->request->post['amount'] == 0) {
				...
				$order_id = $this->model_payment_pp_standard2->getOrderId($this->request->post['transaction_id']);
				$paypal_order = $this->model_payment_pp_standard2->getOrder($order_id);
				...
				if ($paypal_order) {
					...
					$current_transaction = $this->model_payment_pp_standard2->getLocalTransaction($this->request->post['transaction_id']);
					...
					if ($result == false) {
						...
						$this->model_payment_pp_standard2->addTransaction($transaction, $call_data);
						...
						$this->model_payment_pp_standard2->log(json_encode($result));
						...
						$this->response->redirect($this->url->link('payment/pp_standard2/refund', 'token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->post['transaction_id'], 'SSL'));
					}
				} else {
	...
	public function install() {
		$this->load->model('payment/pp_standard2');
		$this->model_payment_pp_standard2->install();
	}

	public function uninstall() {
		$this->load->model('payment/pp_standard2');
		$this->model_payment_pp_standard2->uninstall();
	}

	public function action() {
		if ($this->config->get('pp_standard2_status')) {
			$this->load->model('payment/pp_standard2');
			$this->load->language('payment/pp_standard2_order');

			$paypal_order = $this->model_payment_pp_standard2->getOrder($this->request->get['order_id']);
			...
			if ($paypal_order) {
				...
				$captured = number_format($this->model_payment_pp_standard2->totalCaptured($data['paypal_order']['paypal_order_id']), 2);
				$refunded = number_format($this->model_payment_pp_standard2->totalRefundedOrder($data['paypal_order']['paypal_order_id']), 2);
				...
				$data['refund_link'] = $this->url->link('payment/pp_standard2/refund', 'token=' . $this->session->data['token'], 'SSL');
				$data['view_link'] = $this->url->link('payment/pp_standard2/viewTransaction', 'token=' . $this->session->data['token'], 'SSL');
				$data['resend_link'] = $this->url->link('payment/pp_standard2/resend', 'token=' . $this->session->data['token'], 'SSL');

				return $this->load->view('payment/pp_standard2_order.tpl', $data);
			}
		}
	}

	public function search() {
		$this->load->language('payment/pp_standard2_search');
		$this->load->model('payment/pp_standard2');
		...
		$data['currency_codes'] = $this->model_payment_pp_standard2->currencyCodes();
		$data['default_currency'] = $this->config->get('pp_standard2_currency');
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('payment/pp_standard2/search', 'token=' . $this->session->data['token'], 'SSL'),
		);
		...
		$this->response->setOutput($this->load->view('payment/pp_standard2_search.tpl', $data));
	}
	...
	public function viewTransaction() {
		$this->load->model('payment/pp_standard2');
		$this->load->language('payment/pp_standard2_view');

		$data['transaction'] = $this->model_payment_pp_standard2->getTransaction($this->request->get['transaction_id']);
		$data['lines'] = $this->formatRows($data['transaction']);
		$data['view_link'] = $this->url->link('payment/pp_standard2/viewTransaction', 'token=' . $this->session->data['token'], 'SSL');
		$data['cancel'] = $this->url->link('payment/pp_standard2/search', 'token=' . $this->session->data['token'], 'SSL');
		$data['token'] = $this->session->data['token'];
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('payment/pp_standard2/viewTransaction', 'token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->get['transaction_id'], 'SSL'),
		);
		...
		$this->response->setOutput($this->load->view('payment/pp_standard2_view.tpl', $data));
	}
	...
	public function recurringCancel() {
		...
		if ($recurring && !empty($recurring['reference'])) {
			...
			$result = $this->model_payment_pp_standard2->recurringCancel($recurring['reference']);
	...
	public function recurringButtons() {
		...
		if ($recurring['status_id'] == 2 || $recurring['status_id'] == 3) {
			$data['buttons'][] = array(
				...
				'link' => $this->url->link('payment/pp_standard2/recurringCancel', 'order_recurring_id=' . $this->request->get['order_recurring_id'] . '&token=' . $this->request->get['token'], 'SSL')
			);
		}
