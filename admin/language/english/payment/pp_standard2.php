<?php
// Heading
$_['heading_title']					 = 'PayPal Standard2 Checkout';

// Text
$_['text_payment']				  	 = 'Payment';
$_['text_success']				 	 = 'Success: You have modified PayPal Standard2 Checkout account details!';
$_['text_edit']                      = 'Edit PayPal Express Checkout';
$_['text_pp_standard2']				 = '<a target="_BLANK" href="https://www.paypal.com/uk/mrb/pal=V4T754QB63XXL"><img src="view/image/payment/paypal.png" alt="PayPal Website Payment Pro" title="PayPal Website Payment Pro iFrame" style="border: 1px solid #EEEEEE;" /></a>';
