		  ...
		  <div class="tab-content">
			<div class="tab-pane active" id="tab-api">
			  <div class="form-group required">
				...
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_username" value="<?php echo $pp_standard2_username; ?>" placeholder="<?php echo $entry_username; ?>" id="entry-username" class="form-control" />
			  ...
			  <div class="form-group required">
				...
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_password" value="<?php echo $pp_standard2_password; ?>" placeholder="<?php echo $entry_password; ?>" id="entry-password" class="form-control" />
			  ...
			  <div class="form-group required">
				...
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_signature" value="<?php echo $pp_standard2_signature; ?>" placeholder="<?php echo $entry_signature; ?>" id="entry-signature" class="form-control" />
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_sandbox_username" value="<?php echo $pp_standard2_sandbox_username; ?>" placeholder="<?php echo $entry_sandbox_username; ?>" id="entry-sandbox-username" class="form-control" />
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_sandbox_password" value="<?php echo $pp_standard2_sandbox_password; ?>" placeholder="<?php echo $entry_sandbox_password; ?>" id="entry-sandbox-password" class="form-control" />
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_sandbox_signature" value="<?php echo $pp_standard2_sandbox_signature; ?>" placeholder="<?php echo $entry_sandbox_signature; ?>" id="entry-sandbox-signature" class="form-control" />
			...
			<div class="tab-pane" id="tab-general">
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_test" id="input-live-demo" class="form-control">
					<?php if ($pp_standard2_test) { ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_debug" id="input-debug" class="form-control">
					<?php if ($pp_standard2_debug) { ?>
						<option value="1" selected="selected"><?php echo $text_yes; ?></option>
						<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
						<option value="1"><?php echo $text_yes; ?></option>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_currency" id="input-currency" class="form-control">
					<?php foreach ($currency_codes as $code) { ?>
						<?php if ($code == $pp_standard2_currency) { ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_recurring_cancel_status" id="input-recurring-cancel" class="form-control">
					<?php if ($pp_standard2_recurring_cancel_status) { ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_method" id="input-method" class="form-control">
					<?php if ($pp_standard2_method == 'sale') { ?>
						<option value="Sale" selected="selected"><?php echo $text_sale; ?></option>
					<?php } else { ?>
						<option value="Sale"><?php echo $text_sale; ?></option>
					<?php } ?>
					<?php if ($pp_standard2_method == 'Authorization') { ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_total" value="<?php echo $pp_standard2_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
				</div>
			  </div>
			  <div class="form-group">
				<label class="col-sm-2 control-label" for="input-sort-order"><?php echo $entry_sort_order; ?></label>
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_sort_order" value="<?php echo $pp_standard2_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
				</div>
			  </div>
			  <div class="form-group">
				<label class="col-sm-2 control-label" for="input-geo-zone"><?php echo $entry_geo_zone; ?></label>
				<div class="col-sm-10">
				  <select name="pp_standard2_geo_zone_id" id="input-geo-zone" class="form-control">
					<option value="0"><?php echo $text_all_zones; ?></option>
					<?php foreach ($geo_zones as $geo_zone) { ?>
						<?php if ($geo_zone['geo_zone_id'] == $pp_standard2_geo_zone_id) { ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_status" id="input-status" class="form-control">
					<?php if ($pp_standard2_status) { ?>
						<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
						<option value="0"><?php echo $text_disabled; ?></option>
					<?php } else { ?>
						<option value="1"><?php echo $text_enabled; ?></option>
			...
			<div class="tab-pane" id="tab-order-status">
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_canceled_reversal_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_canceled_reversal_status_id) { ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_completed_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_completed_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_denied_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_denied_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_expired_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_expired_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_failed_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_failed_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_pending_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_pending_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_processed_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_processed_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_refunded_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_refunded_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_reversed_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_reversed_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_voided_status_id" class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $pp_standard2_voided_status_id) { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
						<?php } ?>
			...
			<div class="tab-pane" id="tab-checkout">
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="pp_standard2_allow_note" id="input-notes" class="form-control">
					<?php if ($pp_standard2_allow_note) { ?>
						<option value="1" selected="selected"><?php echo $text_yes; ?></option>
						<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
						<option value="1"><?php echo $text_yes; ?></option>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" name="pp_standard2_page_colour" value="<?php echo $pp_standard2_page_colour; ?>" placeholder="<?php echo $entry_page_colour; ?>" id="input-page-color" class="form-control" />
				</div>
			  </div>
			  <div class="form-group">
				...
				<div class="col-sm-10"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
				  <input type="hidden" name="pp_standard2_logo" value="<?php echo $pp_standard2_logo; ?>" />
				</div>
			  </div>
			</div>
		  </div>
